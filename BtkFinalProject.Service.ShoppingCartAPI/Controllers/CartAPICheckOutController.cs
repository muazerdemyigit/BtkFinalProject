using BtkFinalProject.Service.ShoppingCartAPI.Messages;
using BtkFinalProject.Service.ShoppingCartAPI.Models.Dto;
using BtkFinalProject.Service.ShoppingCartAPI.RabbitMQSender;
using BtkFinalProject.Service.ShoppingCartAPI.Repository;
using Iyzipay;
using Iyzipay.Model;
...
namespace BtkFinalProject.Service.ShoppingCartAPI.Controllers
{
    [Route("api/cartc")]
    public class CartAPICheckOutController : ControllerBase
    {
        ...
        public Payment OdemeIslemi(CheckoutHeaderDto checkoutHeaderDto)
        {
            ...
            paymentCard.CardAlias = "BtkFinalProject";

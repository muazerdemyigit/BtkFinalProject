using BtkFinalProject.Service.OrderAPI.DbContexts;
using BtkFinalProject.Service.OrderAPI.Messaging;
using BtkFinalProject.Service.OrderAPI.RabbitMQSender;
using BtkFinalProject.Service.OrderAPI.Repository;
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("ApiScope", policy =>
    {
        ...
        policy.RequireClaim("scope", "btkfinaloproject");
    });
});
